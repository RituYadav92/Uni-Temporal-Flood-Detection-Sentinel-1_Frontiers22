...
[![Python 3.7+](https://img.shields.io/badge/python-3.7+-blue.svg)][Frontiers in Remote Sensing, DOI: https://doi.org/10.3389/frsen.2022.1060144]

[![Python 3.7+](https://img.shields.io/badge/python-3.7+-blue.svg)]GEE App : https://erritu92.users.earthengine.app/view/flooddetectionunitemporal
## Description: 
